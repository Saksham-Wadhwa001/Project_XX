...
export default function Login() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (email && password) {
      ...
      // Check if user has a role, if not redirect to signup to select role
      ...
      if (userRole === 'consumer') {
        ...
        // If no role, redirect to signup to select role
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-500 items-center justify-center p-12">
        <div className="text-white text-center max-w-md">
          ...
          <p className="text-xl mb-8 opacity-90">
            Login to continue your journey with Project X
          </p>
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-2xl shadow-xl p-8">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600">Login to continue to Project X</p>
            </div>
